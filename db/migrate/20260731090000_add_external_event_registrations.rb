class AddExternalEventRegistrations < ActiveRecord::Migration[8.0]
  def up
    ...
    add_column :subscriptions, :type, :string, default: "AnnualSubscription", null: false
    ...
    add_index :subscriptions,
              %i[member_id year],
              unique: true,
              where: "type = 'AnnualSubscription' AND parent_subscription_id IS NULL",
