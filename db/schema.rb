...
ActiveRecord::Schema[8.0].define(version: 2026_07_31_090000) do
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.index ["member_id", "year"], name: "index_one_annual_subscription_per_member_and_year", unique: true, where: "((registration_type = 0) AND (parent_subscription_id IS NULL))"
