...
module AttendanceRecordsControllerConcern
  ...
  def set_attendance_sheet
    @attendance_sheet = Current.platform.attendance_sheets.find(params.expect(:attendance_sheet_id))
  end

  def set_attendance_record
    @attendance_record = @attendance_sheet.attendance_records.find(params.expect(:id))
  end
end
